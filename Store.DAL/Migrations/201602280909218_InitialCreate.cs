namespace Store.DAL.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        SizeDepth = c.Int(nullable: false),
                        PriceIncome = c.Decimal(nullable: false, precision: 18, scale: 2),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Goods", "Price_Id", "dbo.Prices");
            ...
            DropForeignKey("dbo.OrderItems", "Good_Id", "dbo.Goods");
            DropForeignKey("dbo.Goods", "Color_Id", "dbo.Colors");
            ...
            DropIndex("dbo.OrderItems", new[] { "Good_Id" });
            DropIndex("dbo.Goods", new[] { "Price_Id" });
